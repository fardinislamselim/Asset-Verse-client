...
const EmployeeProfile = () => {
  ...
  const {
    ...
    queryKey: ["employeeProfile", authUser?.email],
    queryFn: async () => {
  ...
  useEffect(() => {
    if (employee) {
      ...
      setProfileImage(employee.profileImage || authUser?.photoURL || "");
    }
  }, [employee, authUser]);
        ...
        <div className="bg-base-100 shadow-xl rounded-2xl p-8 text-center">
          ...
          <div className="mt-10 bg-base-200 rounded-2xl p-6 shadow-inner">
            ...
            {affLoading ? (
              ...
              <p className="text-gray-500">No company affiliation yet</p>
            ) : (
              <div className="space-y-4">
                {affiliations.map((aff) => (
                  ...
                  >
                    <img
                      src={aff.companyLogo || "/default-company-logo.jpg"}
                      alt={aff.companyName}
