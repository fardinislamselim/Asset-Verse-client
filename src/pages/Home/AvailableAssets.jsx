      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-black mb-4 text-neutral">
            Available <span className="text-primary">Assets</span>
          </h1>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg">
            Explore our comprehensive catalog of assets. Find exactly what you need with our advanced filtering and search capabilities.
          </p>
        </div>
                ...
                >
                  ...
                  <div className="card-body p-5 flex-grow flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 line-clamp-2 mb-3 flex-grow-0 min-h-[40px]">
                      High-quality {asset.productName.toLowerCase()} provided by {asset.companyName}. Perfect for professional use.
                    </p>
